...
def parse_args():
    ...
    parser.add_argument('--method',
                        ...
                        dest='method',
                        metavar='METHOD',
                        help='old or new method')

    parser.add_argument('--genenum',
                        type=int,
                        dest='genenum',
                        metavar='GENENUM',
                        help='Gene number to learn')
...
if opts.genenum < 0 :
    raise Exception("Must specify gene number to learn.")

for i, gene in enumerate(genes):

# if True:

    if gene.ensembl_id != "ENSG00000116251.5":
        continue

    # i = 0
    # gene = genes[opts.genenum]
