...
do
	...
	MODELPATH='/usr/users/fsimone/datasets/gtex/gxpred_models_klinikum'
	# CHROM="1"
	GTPATH="/usr/users/fsimone/datasets/cardiogenics/genotypes"
	GTFILE="CG_${CHROM}.imputed.gz"
	LOGDIR="/usr/users/fsimone/datasets/cardiogenics/gxpred_predictions_klinikum"
	OUTDIR="/usr/users/fsimone/datasets/cardiogenics/gxpred_predictions_klinikum/pred_chr${CHROM}"
